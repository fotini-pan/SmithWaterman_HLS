...
if {[file isfile SmithWaterman.autotvin.dat]} {
	file delete -force SmithWaterman.autotvin.dat
}

if {[file isfile SmithWaterman.autotvout.dat]} {
	file delete -force SmithWaterman.autotvout.dat
}
