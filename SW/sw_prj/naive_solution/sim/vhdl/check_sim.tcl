...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.SmithWaterman.autotvin_seq1.dat"
         "c.SmithWaterman.autotvin_seq2.dat"
         "c.SmithWaterman.autotvin_aligned_seq1.dat"
         "c.SmithWaterman.autotvin_aligned_seq2.dat"
         "c.SmithWaterman.autotvout_aligned_seq1.dat"
         "c.SmithWaterman.autotvout_n.dat"
         "c.SmithWaterman.autotvout_aligned_seq2.dat"
         "c.SmithWaterman.autotvout_m.dat"
         "c.SmithWaterman.autotvout_l.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.SmithWaterman.autotvout_aligned_seq1.dat"
         "rtl.SmithWaterman.autotvout_n.dat"
         "rtl.SmithWaterman.autotvout_aligned_seq2.dat"
         "rtl.SmithWaterman.autotvout_m.dat"
         "rtl.SmithWaterman.autotvout_l.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
