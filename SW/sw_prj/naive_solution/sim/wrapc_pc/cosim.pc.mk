...
$(ObjDir)/SmithWaterman_test.c_pre.c.tb.o : SmithWaterman_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) SmithWaterman_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/SmithWaterman.c_pre.c.tb.o : SmithWaterman.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) SmithWaterman.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
