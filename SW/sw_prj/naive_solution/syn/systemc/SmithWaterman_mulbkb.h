...
// ==============================================================
#ifndef __SmithWaterman_mulbkb__HH__
#define __SmithWaterman_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(SmithWaterman_mulbkb) {
    ...
    SC_CTOR(SmithWaterman_mulbkb):  ACMP_smul_us_U ("ACMP_smul_us_U") {
